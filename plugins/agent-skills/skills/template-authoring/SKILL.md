...
description: Load this skill when authoring or reviewing portable .md.eta templates, agent-skills front-config, includes, layouts, or opaque assets for @goodfoot/agent-skills.
---
