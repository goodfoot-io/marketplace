...
description: Load this skill when using the @goodfoot/agent-skills build or lint CLI, or when choosing portable Eta helpers for skills, agents, worktrees, frontmatter, and platform paths.
---
