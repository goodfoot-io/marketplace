...
var skill_cleanup_default = sessionEndHook({}, (input, { logger: logger2 }) => {
  ...
  try {
    ...
    logger2.info("Session cleanup completed", { file: skillsFile });
  } catch {
  }
