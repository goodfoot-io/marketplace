...
For each candidate identified, verify whether the data flow is actually broken using parallel Tracer subagents.
...
<parameter name="subagent_type">Tracer</parameter>
