...
npx @goodfoot/agent-hooks --agent codex --scaffold ./packages/my-codex-hooks \
  ...
  -o ../../plugins-opencode/my-plugin/.codex/hooks.json
```

This generates the build script:
```json
"build": "npx -y @goodfoot/agent-hooks --agent codex -i \"src/**/*.ts\" -o \"../../plugins-opencode/my-plugin/.codex/hooks.json\""
```
...
npm run build
# Check: plugins-opencode/my-plugin/.codex/hooks.json should exist
cat ../../plugins-opencode/my-plugin/.codex/hooks.json | jq .
```
