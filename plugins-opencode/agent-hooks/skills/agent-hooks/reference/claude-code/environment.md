...
```typescript
import { getProjectDir } from '@goodfoot/agent-hooks/claude-code';
...
```typescript
import { isRemoteEnvironment } from '@goodfoot/agent-hooks/claude-code';
...
```typescript
import { CLAUDE_ENV_VARS } from '@goodfoot/agent-hooks/claude-code';
