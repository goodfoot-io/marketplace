...
if [ ! -d "$CRED_PATH" ]; then
  ...
  echo "If yes, read: @plugins-opencode/gmail/skills/gmail/advanced/oauth-setup.md"
  ...
  echo "Setup guide: @plugins-opencode/gmail/skills/gmail/advanced/oauth-setup.md"
...
> This environment check auto-executes on Claude Code load. On OpenCode it is documented example code above — run it manually to verify Gmail credentials before use.
