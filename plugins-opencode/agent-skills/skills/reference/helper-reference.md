...
| it.platformDir | logicalPathKind | Resolve the configured "skills" path. | configured path (verified) | configured path (verified) | configured path (verified) | configured path (provisional) |
| it.platformDir | logicalPathKind | Resolve the configured "agents" path. | configured path (verified) | configured path (verified) | configured path (verified) | unavailable (unavailable) |
...
| it.platformDir | logicalPathKind | Resolve the configured "plugin" path. | configured path (verified) | configured path (verified) | configured path (verified) | unavailable (unavailable) |
| it.platformDir | logicalPathKind | Resolve the configured "conventions" path. | configured path (verified) | configured path (verified) | configured path (verified) | configured path (provisional) |
