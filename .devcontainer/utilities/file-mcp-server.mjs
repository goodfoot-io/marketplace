...
server.setRequestHandler(ListToolsRequestSchema, () => ({
  tools: [
    {
      name: "append",
      description: "Appends content to a file. Creates the file if it does not exist. Automatically creates parent directories if needed. Ensures content starts on a new line if the file does not end with a newline.",
      inputSchema: {
        type: "object",
        properties: {
          file_path: {
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  const { file_path, content } = request.params.arguments;
  if (!file_path) {
