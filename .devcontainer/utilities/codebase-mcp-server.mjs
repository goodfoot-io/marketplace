...
// src/codebase.ts
var WORKSPACE_PATH = process.cwd();
...
async function logQuestionAnswer(question, transcript) {
...
server.setRequestHandler(ListToolsRequestSchema, () => ({
  tools: [
    {
      name: "ask",
      description: "Searches and analyzes codebases to answer technical questions. Finds definitions, traces errors, maps dependencies, and explains code flow. Best for focused questions about specific files or errors. Always provide full paths in monorepos (e.g., packages/api/src/file.ts).",
      inputSchema: {
        type: "object",
        properties: {
          question: {
            type: "string",
            description: 'INSTEAD OF: "Analyze file: 1) How it processes 2) What imports it 3) Performance"\nUSE PARALLEL: ["How does file process?", "What imports file?", "Performance impact?"]\n\nEXAMPLES:\n\u2713 "TypeScript error TS2322 at packages/api/src/user.ts:45: Why is email required?"\n\u2713 "What files import from packages/shared/src/types/user.ts?"\n\u2713 "How does packages/api/src/services/user.ts depend on database types?"\n\u2717 "How does useTranscriptSync work?" (missing full path)\n\u2717 "Find all bugs" (too vague)'
          }
        },
        required: ["question"]
      }
