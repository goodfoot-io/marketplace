...
**Configuring the log file:** Logging is configured at runtime, not at build time. Set the `AGENT_HOOKS_LOG_FILE` environment variable to write JSON-line logs to a file, or configure programmatically with `new Logger({ logFilePath })` / `new Logger({ logEnvVar })`. See [Logging & Debugging](@${PLUGIN_ROOT}/skills/codex/reference/logging.md).
...
```
See [Installation: Scaffolding for Monorepos](@${PLUGIN_ROOT}/skills/codex/reference/installation.md).
...
```
See [Monorepo Integration](@${PLUGIN_ROOT}/skills/codex/reference/installation.md).
...
*   **[Installation & Setup](@${PLUGIN_ROOT}/skills/codex/reference/installation.md)**: Setup guide (Scaffolding vs Manual).
*   **[All 10 Hook Inputs](@${PLUGIN_ROOT}/skills/codex/reference/input-types.md)**: Field shapes per event, with `tool_input` narrowing.
*   **[All 10 Output Builders](@${PLUGIN_ROOT}/skills/codex/reference/output-builders.md)**: Factories, builders, and option types.
*   **[Porting from Bash](@${PLUGIN_ROOT}/skills/codex/reference/porting.md)**: Migration guide.
*   **[Logging & Debugging](@${PLUGIN_ROOT}/skills/codex/reference/logging.md)**: How to see what's happening.
*   **[Environment](@${PLUGIN_ROOT}/skills/codex/reference/environment.md)**: Hook context and runtime env.
