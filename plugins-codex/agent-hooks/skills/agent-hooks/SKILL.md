...
- `reference/antigravity.md` — the in-repo Antigravity surface: not a consumable package target yet; covers the implemented surface and its release boundary. Load whenever Antigravity hooks come up.
