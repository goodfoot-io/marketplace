...
Related: why typing matters `../explanation/principles/02-typed-source-of-truth-topics.md`; the catalogs `../reference/page-genres.md`, `../reference/topic-types.md`; record an unenforced coupling `../reference/tools/git-span.md`; find duplicates `../reference/tools/inventory-grep.md`.
