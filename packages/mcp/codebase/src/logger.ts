/**
 * Optional logging system for codebase MCP server
 * Controlled by CODEBASE_MCP_SERVER_LOGGING environment variable
 */
...
function isLoggingEnabled(): boolean {
  return process.env.CODEBASE_MCP_SERVER_LOGGING === 'true';
}
