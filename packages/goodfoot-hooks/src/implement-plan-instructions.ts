/**
 * Implement-plan instructions for restoration after context compaction.
 *
 * Contains the operational guidelines and steps needed to continue
 * implement-plan execution after compaction (excludes Steps 1 and 3
 * which are already completed before compaction occurs).
 */

export const IMPLEMENT_PLAN_INSTRUCTIONS = `
