export const PLATFORMS = ["claude-code", "codex", "opencode", "antigravity"] as const;
...
export interface BuildResult {
  ...
  readonly written: readonly { readonly target: OutputTarget; readonly files: readonly string[] }[];
}
