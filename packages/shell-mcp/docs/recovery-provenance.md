...
- `recovered/attempt-2/src/contracts.ts`, `errors.ts`, and cursor/UTF-8 utilities supplied the tool schemas, descriptions, recovery codes, result vocabulary, and instance-bound cursor design. They were reformatted for this workspace and reconciled with runtime byte limits.
...
- The reconstructed component tests were ported into the package test layout and extended with manager, HTTP, and retry tests.
