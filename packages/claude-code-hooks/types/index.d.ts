 ...
 * @module
 */
export type { BaseHookInput, PreToolUseInput, PostToolUseInput, PostToolUseFailureInput, NotificationInput, UserPromptSubmitInput, SessionStartInput, SessionEndInput, StopInput, SubagentStartInput, SubagentStopInput, PreCompactInput, PermissionRequestInput, HookInput, HookEventName, PermissionMode, SessionStartSource, SessionEndReason, PreCompactTrigger, PermissionUpdate } from './types/inputs.js';
export { HOOK_EVENT_NAMES } from './types/inputs.js';
export type { HookOutput, SyncHookJSONOutput, ExitCode, HookSpecificOutput, PreToolUseHookSpecificOutput, PostToolUseHookSpecificOutput, PostToolUseFailureHookSpecificOutput, UserPromptSubmitHookSpecificOutput, SessionStartHookSpecificOutput, SubagentStartHookSpecificOutput, PermissionRequestHookSpecificOutput, PermissionRequestDecision, PermissionRequestAllowDecision, PermissionRequestDenyDecision, CommonOptions, 
/** @deprecated Use CommonOptions instead */
BaseOptions, PreToolUseOptions, PostToolUseOptions, PostToolUseFailureOptions, UserPromptSubmitOptions, SessionStartOptions, SessionEndOptions, StopOptions, SubagentStartOptions, SubagentStopOptions, NotificationOptions, PreCompactOptions, PermissionRequestOptions } from './outputs.js';
...
export { CLAUDE_ENV_VARS, getProjectDir, getEnvFilePath, isRemoteEnvironment, persistEnvVar, persistEnvVars } from './env.js';
