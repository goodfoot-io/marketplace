 ...
 */
export declare function preToolUseOutput(options: PreToolUseOptions): HookOutput;
/**
 ...
 */
export declare function postToolUseOutput(options: PostToolUseOptions): HookOutput;
/**
 ...
 */
export declare function postToolUseFailureOutput(options: PostToolUseFailureOptions): HookOutput;
/**
 ...
 */
export declare function userPromptSubmitOutput(options: UserPromptSubmitOptions): HookOutput;
/**
 ...
 */
export declare function sessionStartOutput(options: SessionStartOptions): HookOutput;
/**
 ...
 */
export declare function sessionEndOutput(options: SessionEndOptions): HookOutput;
/**
 ...
 */
export declare function stopOutput(options: StopOptions): HookOutput;
/**
 ...
 */
export declare function subagentStartOutput(options: SubagentStartOptions): HookOutput;
/**
 ...
 */
export declare function subagentStopOutput(options: SubagentStopOptions): HookOutput;
/**
 ...
 */
export declare function notificationOutput(options: NotificationOptions): HookOutput;
/**
 ...
 */
export declare function preCompactOutput(options: PreCompactOptions): HookOutput;
/**
 ...
 */
export declare function permissionRequestOutput(options: PermissionRequestOptions): HookOutput;
