...
describe("scaffold", () => {
  it("creates a starter project", () => {
    ...
    expect(generatedPackageJson.dependencies["@goodfoot/claude-code-hooks"]).toBeDefined();
    ...
    expect(generatedPackageJson.dependencies["@goodfoot/claude-code-hooks"]).toBe(`^${ownVersion}`);
  });
});
