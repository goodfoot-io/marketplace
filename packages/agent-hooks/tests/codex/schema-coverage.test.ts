...
import { HOOK_FACTORY_TO_EVENT } from "../../src/agents/codex/constants.js";
...
const schemaDir = path.resolve(fileURLToPath(import.meta.url), "../../../src/agents/codex/schema/generated");
