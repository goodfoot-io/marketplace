...
import type { HookContext, SessionStartContext } from "../src/agents/claude-code/hooks.js";
import {
  configChangeHook,
  cwdChangedHook,
  elicitationHook,
  ...
  worktreeCreateHook,
  worktreeRemoveHook,
} from "../src/agents/claude-code/hooks.js";
import {
  configChangeOutput,
  cwdChangedOutput,
  elicitationOutput,
...
import type { PermissionRequestInput, SessionEndInput } from "../src/agents/claude-code/types.js";
...
describe("Hook Factory Functions", () => {
  ...
  describe("postToolUseFailureHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("PostToolUseFailure");
    });
  ...
  describe("preCompactHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("PreCompact");
    });
  ...
  describe("permissionRequestHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("PermissionRequest");
    });
  ...
  describe("elicitationHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("Elicitation");
    });
  ...
  describe("elicitationResultHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("ElicitationResult");
    });
  ...
  describe("configChangeHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("ConfigChange");
    });
  ...
  describe("instructionsLoadedHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("InstructionsLoaded");
    });
  ...
  describe("worktreeCreateHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("WorktreeCreate");
    });
  ...
  describe("worktreeRemoveHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("WorktreeRemove");
    });
  ...
  describe("cwdChangedHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("CwdChanged");
    });
  ...
  describe("fileChangedHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("FileChanged");
    });
  ...
  describe("messageDisplayHook", () => {
    it("returns a HookFunction with correct hookEventName", () => {
      ...
      expect(hook.eventName).toBe("MessageDisplay");
    });
