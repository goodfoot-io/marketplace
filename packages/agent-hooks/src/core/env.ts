 ...
 * @example
 * ```typescript
 * import { getProjectDir, persistEnvVar, isRemoteEnvironment } from '@goodfoot/agent-hooks';
 *
 ...
 * @example
 * ```typescript
 * import { sessionStartHook, sessionStartOutput, persistEnvVar } from '@goodfoot/agent-hooks';
 *
