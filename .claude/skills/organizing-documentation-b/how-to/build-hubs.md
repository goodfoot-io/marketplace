...
A README of 3 lines or fewer must expand to at minimum: a heading, a scope statement (one sentence identifying what this directory/file owns), a "How it works" or "Quick start" section, and cross-references to related documents. Do not leave a stub.
...
1. **Root README**: Add a dedicated navigation section that lists every major navigation surface with a one-line description (alphabetical index, cross-reference indexes, preface, help guide, draft area, contributing guide).
