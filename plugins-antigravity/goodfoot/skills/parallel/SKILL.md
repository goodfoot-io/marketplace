...
Name the tier using whatever model or effort setting your host's subagent dispatch accepts.
...
Delegate to the `general-purpose` subagent with `invoke_subagent`.
