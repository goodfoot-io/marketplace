...
Related: the loop these signals feed `../../how-to/procedure.md`; the drift gates `../../reference/tools/git-span.md`, `../../reference/tools/wiki.md`.
