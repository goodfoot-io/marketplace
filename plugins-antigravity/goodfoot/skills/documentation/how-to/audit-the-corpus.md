...
- **Long documents** (>500 lines): flag for a scope statement plus a navigational index — a table of contents, or, for a flat changelog or history of many version headings, a curated version/year index.
...
- **Long document, no navigational index (>500 lines, including a flat changelog)** → `build-hubs.md`.
