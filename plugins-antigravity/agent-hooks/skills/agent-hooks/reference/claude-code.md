...
```
See [Installation: Scaffolding for Monorepos](claude-code/installation.md#11-scaffolding-for-monorepos).
...
See [Checking Multiple Patterns](claude-code/input-types.md#checking-multiple-patterns) for the complete example.
...
See [Run Validation and Report Errors](claude-code/output-builders.md#goal-run-validation-and-report-errors-posttooluse) for details.
...
**Monorepo Project:**
For hooks in a separate package that output to a plugin directory, see [Monorepo Integration](claude-code/installation.md#5-monorepo-integration). This is the recommended pattern for migrating existing hooks.

## 9. Reference Links

*   **[Installation & Setup](claude-code/installation.md)**: Setup guide (Scaffolding vs Manual).
*   **[All 17 Hook Types](claude-code/output-builders.md)**: Factories, builders, and inputs.
*   **[Tool Input Types](claude-code/input-types.md)**: Type guards, helpers, and typed overloads.
*   **[Porting from Bash](claude-code/porting.md)**: Migration guide.
*   **[Logging & Debugging](claude-code/logging.md)**: How to see what's happening.
*   **[Environment Vars](claude-code/environment.md)**: `getProjectDir`, `persistEnvVar`.
