...
```bash
npx @goodfoot/agent-hooks --agent codex --scaffold ./packages/my-codex-hooks --hooks PreToolUse,PostToolUse -o ../../plugins-codex/my-plugin/.codex/hooks.json
```
...
```bash
npx -y @goodfoot/agent-hooks --agent codex -i "src/**/*.ts" -o "../../plugins-codex/my-plugin/hooks/hooks.json" --plugin-root
```
