...
This document describes the typed tool input structures available in `@goodfoot/agent-hooks/claude-code`.
...
```typescript
import { isNotebookEditTool } from '@goodfoot/agent-hooks/claude-code';
...
```typescript
import { getFilePath } from '@goodfoot/agent-hooks/claude-code';
...
```typescript
import { isJsTsFile, isTsFile } from '@goodfoot/agent-hooks/claude-code';
...
```typescript
import { checkContentForPattern } from '@goodfoot/agent-hooks/claude-code';
...
```typescript
import { forEachContent } from '@goodfoot/agent-hooks/claude-code';
...
```typescript
// These types are available directly from @goodfoot/agent-hooks/claude-code
